...
import { listConversations, getMessages, sendMessage, hideThread } from "./routes/messages";
...
export function createServer() {
  ...
  app.post("/api/users/delete-photo-from-session", deletePhotoFromSession);
  ...
  app.post("/users/delete-photo-from-session", deletePhotoFromSession);
  ...
  app.get(
    "/admin/reports/:reportId/details",
    requireModeratorOrAdmin,
    getReportDetails,
  );
  app.post(
