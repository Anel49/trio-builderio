...
export async function listListings(req: Request, res: Response) {
  try {
    ...
    try {
      ...
      sql += ` group by l.id, l.name, l.price_cents, l.rating, l.image_url, l.host, l.category, l.description, l.zip_code, l.created_at, l.latitude, l.longitude, l.rental_period, l.user_id, l.delivery, l.free_delivery, l.enabled, u.open_dms, u.created_at, u.username
  ...
  try {
    ...
    try {
      result = await pool.query(
        `insert into listings (name, price_cents, rating, image_url, host, user_id, category, rental_period, description, zip_code, location_city, latitude, longitude, delivery, free_delivery)
    ...
    try {
      result = await pool.query(
        `select l.id, l.name, l.price_cents, l.rating, l.image_url, l.host, l.category, l.description, l.zip_code, l.created_at, l.rental_period, l.latitude, l.longitude, l.user_id,
         ...
         left join users u on l.user_id = u.id
         where l.id = $1
         group by l.id, l.name, l.price_cents, l.rating, l.image_url, l.host, l.category, l.description, l.zip_code, l.created_at, l.rental_period, l.latitude, l.longitude, l.delivery, l.free_delivery, l.enabled, u.open_dms, u.created_at, l.user_id`,
        [id],
      );
    } catch (e) {
      return res
