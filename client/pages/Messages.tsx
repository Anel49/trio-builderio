        ...
        <div className="h-full flex overflow-hidden shadow-sm relative">
          ...
          {!leftSidebarOpen && (
            <div
              ...
              className="fixed left-0 top-1/2 -translate-y-1/2 h-32 w-3 bg-primary/20 hover:bg-primary/40 transition-colors z-20 md:hidden flex items-center justify-center cursor-pointer rounded-r-md"
            >
          ...
          {!rightSidebarOpen && (
            <div
              ...
              className="fixed right-0 top-1/2 -translate-y-1/2 h-32 w-3 bg-primary/20 hover:bg-primary/40 transition-colors z-20 md:hidden flex items-center justify-center cursor-pointer rounded-l-md"
            >
              <div className="w-1 h-8 bg-primary/60 rounded-full"></div>
            </div>
          )}
