                  ...
                  <div className="flex items-center space-x-2 p-4 border rounded-lg">
                    ...
                    <Label htmlFor="paypal" className="flex-1 cursor-pointer">
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 bg-white border border-gray-200 rounded flex items-center justify-center">
                          <svg width="24" height="24" viewBox="0 0 24 24" className="w-6 h-6">
                            <path fill="#003087" d="M8.68 5.5h4.82c2.12 0 3.85 1.73 3.85 3.85v.01c-.01 2.11-1.73 3.83-3.84 3.83h-2.88L9.65 18.5H7.38L8.68 5.5z"/>
                            <path fill="#009CDE" d="M8.68 5.5c-.67 0-1.21.54-1.21 1.21v.01c0 .67.54 1.21 1.21 1.21h4.82c1.78 0 3.22 1.44 3.22 3.22v.01c-.01 1.77-1.45 3.21-3.22 3.21h-2.88L9.65 18.5H7.38L8.68 5.5z"/>
                            <path fill="#012069" d="M16.87 9.56v.01c-.01 2.11-1.73 3.83-3.84 3.83h-2.88L9.17 18.5H6.9L8.2 5.5h4.82c2.12 0 3.85 1.73 3.85 3.85v.01c0 .09 0 .17-.01.26h.01v-.06z"/>
                          </svg>
                        </div>
                        <span>PayPal</span>
                      </div>
