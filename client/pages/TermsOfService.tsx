    ...
    <section id="account-requirements">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed mb-3">All profile names must be free
            ...
            may result in a forced renaming, suspension, or deletion
            of your account.</p>
        </div>
        <div>
          <h3 className="text-lg font-medium mb-2">Conduct</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
            All chat messages must remain respectful and appropriate.
