          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    We use analytics cookies to understand how our website is
                    being used and to improve our services based on user
                    behavior.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>
                  Adjust your preferences in our cookie settings (when
                  available)
                </li>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                contact us at cookies@trio.com or through our support channels.
              </p>
            </section>
          </div>
        </ScrollArea>
