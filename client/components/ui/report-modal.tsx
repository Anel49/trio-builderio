...
const reportCategories = [
  ...
  },
  {
    ...
    description: "Includes curse words, pejoratives, slurs, sexual innuendos, discriminatory language, or references to illegal or unsafe behavior."
  },
  {
    id: "spam",
    label: "Spam",
    description: "Includes promotional content, repeated or irrelevant text, links to external websites, or attempts to direct users off-platform for booking or communication."
  }
];

export function ReportModal({ isOpen, onOpenChange, listingTitle }: ReportModalProps) {
