      ...
      <DialogContent className="max-w-2xl max-h-[80vh]">
        ...
        <ScrollArea className="max-h-[60vh] pr-4">
          <div className="space-y-6">
            ...
            {/* Sending Payment Section */}
            <div>
              <h3 className="text-lg font-semibold mb-4">Sending payment</h3>
            ...
            {/* Receiving Payment Section */}
            <div>
              <h3 className="text-lg font-semibold mb-4">Receiving payment</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <Button
                  variant="outline"
                  className="w-full justify-start h-12"
                ...
                <Button
                  variant="outline"
                  className="w-full justify-start h-12"
                  onClick={() => handlePaymentConnect("Google Wallet")}
                >
                  <div className="flex items-center space-x-3">
                    <svg className="w-6 h-6" viewBox="0 0 24 24">
                      <path
