          ...
          <div className="space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                By accessing and using Trio, you accept and agree to be bound by these Terms of Service. 
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4">
                Trio is a peer-to-peer marketplace that allows users to rent and lend items to each other. 
                We provide the platform to facilitate these transactions but are not a party to the rental agreements.
              </p>
            </section>
            ...
            <section>
              <h3 className="text-lg font-semibold mb-3">5. Payments and Fees</h3>
              <p className="text-muted-foreground mb-4">
                Trio charges service fees for successful rentals. These fees are clearly disclosed before 
                completing any transaction. Payment processing is handled by secure third-party providers.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Trio is not responsible for the condition, safety, or legality of items listed, the truth 
                or accuracy of listings, or the ability of users to complete transactions. We provide the 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Any disputes arising from these terms or your use of Trio shall be resolved through binding 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                For questions about these Terms of Service, contact us at legal@trio.com or through 
