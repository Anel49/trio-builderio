...
export const { grid, gap, padding, margin, dimensions } = spacing;

export const { size, weight, lineHeight } = typography;

export const { duration, transition, transform } = animations;
