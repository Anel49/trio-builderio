  ...
  const generalFAQs: FAQItem[] = [
    {
      ...
      answer:
        "LendIt is a peer-to-peer rental marketplace where users can rent everyday items from one another, including but not limited to tools, clothing, electronics, sports gear, and event supplies.",
    },
    {
