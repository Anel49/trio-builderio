    ...
    try {
      ...
      const reservationResponse = await apiFetch("reservations", {
        ...
        body: JSON.stringify({
          ...
          host_email: product?.hostEmail ?? null,
      ...
      try {
        ...
        if (!cancelled) {
          setProduct({
            ...
            hostEmail: typeof l.hostEmail === "string" ? l.hostEmail : null,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <Dialog open={isLightboxOpen} onOpenChange={setIsLightboxOpen}>
              <DialogContent className="w-[92vw] max-w-5xl p-0 bg-transparent border-none shadow-none rounded-none [&>button]:right-4 [&>button]:top-7 [&>button]:text-white [&>button:hover]:text-white [&>button]:bg-black/40 [&>button]:rounded-full [&>button]:z-20 [&>button]:w-7 [&>button]:h-7 [&>button]:flex [&>button]:items-center [&>button]:justify-center">
                <DialogHeader>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div>
              ...
              {(product.delivery || product.freeDelivery) && (
              ...
              {product?.addons && product.addons.length > 0 && (
                <div className="border border-border rounded-lg mb-6">
                  <button
                    ...
                    className={`w-full flex items-center justify-between py-4 px-4 bg-background hover:bg-accent/50 transition-colors ${
                      isAddonsExpanded
                    ...
                    try {
                      ...
                      if (data && data.ok && Array.isArray(data.reservations)) {
                        ...
                        if (hasConflict) {
                          ...
                          // Check if listing has addons
                          if (product?.addons && product.addons.length > 0) {
                            setShowAddonsModal(true);
                          } else {
                            // No addons, go directly to booking summary
                            setSelectedAddons([]);
                            setShowBookingSummaryModal(true);
                          }
                        }
