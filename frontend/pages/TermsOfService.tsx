  ...
  <>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            responsible for coordinating the pickup and return logistics
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            helps maintain trust and safety within our communities.
          </p>
        </div>
        <div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-4">
            ...
            <li>Items requiring special licenses or training</li>
    ...
    <section id="privacy-data">
      ...
      <p className="text-muted-foreground leading-relaxed">
        ...
        personal information in accordance with our Privacy Policy. By using {COMPANY_NAME},
