      ...
      >
        ...
        <div className="px-4 pb-4 h-full">
          <Card className="h-full overflow-hidden">
            <CardContent className="p-0 h-full relative">
              {/* Map Placeholder - Same as desktop version */}
              <div className="w-full h-full bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center relative">
                {/* Map Background */}
                <div className="absolute inset-0 bg-gradient-to-br from-blue-100 to-green-100"></div>
                  ...
                  {filteredAndSortedListings.map((listing, index) => (
                    ...
                    >
                      ...
                      <div
                        ...
                        onTouchEnd={() => {
                          setTimeout(() => setShowPricePopup(null), 2000);
                        }}
                      >
                        <span
                          className={cn(
                ...
                {/* Map Label */}
                <div className="absolute bottom-16 left-4 bg-white/90 dark:bg-gray-800/90 px-3 py-2 rounded-lg">
                  <p className="text-sm font-medium dark:text-white">
                    Interactive Map
                  </p>
                  <p className="text-xs text-muted-foreground dark:text-gray-300">
