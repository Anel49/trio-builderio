            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="relative">
                  ...
                  {showValidationTooltip && (
                    <div className="validation-tooltip absolute bottom-full left-0 right-0 mb-2 bg-red-600 text-white px-6 py-3 rounded-lg text-sm z-50 shadow-xl pointer-events-none">
